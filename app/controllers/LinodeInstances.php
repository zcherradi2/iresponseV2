...
use \IR\App\Models\Admin\LinodeInstance as LinodeInstance;
...
/**
 * @name LinodeInstances
 * @description LinodeInstances Controller
 */
class LinodeInstances extends Controller
{
    ...
    { 
        ...
        $this->masterView->set([
            ...
            'linode_instances' => 'true',
            'linode_instances_show' => 'true'
        ]);
    ...
    { 
        ...
        if(count($data))
        {
            ...
            die(json_encode(DataTable::init($data,'admin.linode_instances',$columns,new LinodeInstance(),'linode_instances','DESC',null,false)));
        }
    }
    ...
    { 
        ...
        # set data to the page view
        $this->pageView->set([
            'accounts' => LinodeAccount::all(LinodeAccount::FETCH_ARRAY,['status = ?','Activated'],['id','name']),
    ...
    { 
        ...
        if(count($data))
        {
            ...
            # fetching the results to create the ajax list
            die(json_encode(DataTable::init($data,'admin.linode_processes',$columns,new LinodeProcess(),'linode_processes','DESC',null,false)));
        }
    }
