...
# models
use IR\App\Models\Admin\AtlanticInstance as AtlanticInstance;
...
/**
 * @name AtlanticInstances
 * @description AtlanticInstances Controller
 */
class AtlanticInstances extends Controller
{
    /**
     * @app
     * @readwrite
    ...
    { 
        ...
        $this->masterView->set([
            ...
            'atlantic_instances' => 'true',
            'atlantic_instances_show' => 'true'
        ]);
    ...
    { 
        ...
        if(count($data))
        {
            ...
            die(json_encode(DataTable::init($data,'admin.atlantic_instances',$columns,new AtlanticInstance(),'atlantic-instances','DESC',null,false)));
        }
    }
    ...
    { 
        ...
        $this->masterView->set([
            ...
            'atlantic_management' => 'true',
            'atlantic_instances' => 'true',
            'atlantic_instances_create' => 'true'
        ]);
        ...
        # set data to the page view
        $this->pageView->set([
            'accounts' => AtlanticAccount::all(AtlanticAccount::FETCH_ARRAY,['status = ?','Activated'],['id','name']),
    ...
    { 
        ...
        if(count($data))
        {
            ...
            # fetching the results to create the ajax list
            die(json_encode(DataTable::init($data,'admin.atlantic_processes',$columns,new AtlanticProcess(),'atlantic-instances','DESC',null,false)));
        }
    }
