...
# models
use IR\App\Models\Admin\ScalewayInstance as ScalewayInstance;
...
/**
 * @name ScalewayInstances
 * @description ScalewayInstances Controller
 */
class ScalewayInstances extends Controller
{
    /**
     * @app
     * @readwrite
    ...
    { 
        ...
        $this->masterView->set([
            ...
            'scaleway_instances' => 'true',
            'scaleway_instances_show' => 'true'
        ]);
    ...
    { 
        ...
        if(count($data))
        {
            ...
            die(json_encode(DataTable::init($data,'admin.scaleway_instances',$columns,new ScalewayInstance(),'scaleway-instances','DESC',null,false)));
        }
    }
    ...
    { 
        ...
        $this->masterView->set([
            ...
            'scaleway_management' => 'true',
            'scaleway_instances' => 'true',
            'scaleway_instances_create' => 'true'
        ]);
        ...
        # set data to the page view
        $this->pageView->set([
            'accounts' => ScalewayAccount::all(ScalewayAccount::FETCH_ARRAY,['status = ?','Activated'],['id','name']),
    ...
    { 
        ...
        if(count($data))
        {
            ...
            # fetching the results to create the ajax list
            die(json_encode(DataTable::init($data,'admin.scaleway_processes',$columns,new ScalewayProcess(),'scaleway-instances','DESC',null,false)));
        }
    }
