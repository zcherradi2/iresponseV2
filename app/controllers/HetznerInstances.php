...
# models
use IR\App\Models\Admin\HetznerInstance as HetznerInstance;
...
/**
 * @name HetznerInstances
 * @description HetznerInstances Controller
 */
class HetznerInstances extends Controller
{
    /**
     * @app
     * @readwrite
    ...
    { 
        ...
        $this->masterView->set([
            ...
            'hetzner_instances' => 'true',
            'hetzner_instances_show' => 'true'
        ]);
    ...
    { 
        ...
        if(count($data))
        {
            ...
            die(json_encode(DataTable::init($data,'admin.hetzner_instances',$columns,new HetznerInstance(),'hetzner-instances','DESC',null,false)));
        }
    }
    ...
    { 
        ...
        # set data to the page view
        $this->pageView->set([
            'accounts' => HetznerAccount::all(HetznerAccount::FETCH_ARRAY,['status = ?','Activated'],['id','name']),
    ...
    { 
        ...
        if(count($data))
        {
            ...
            # fetching the results to create the ajax list
            die(json_encode(DataTable::init($data,'admin.hetzner_processes',$columns,new HetznerProcess(),'hetzner-instances','DESC',null,false)));
        }
    }
