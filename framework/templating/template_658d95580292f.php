...
$_text[] = "</title>
        ...
        ";function anon_SywZZIfr($_data){};
$_text[] = anon_SywZZIfr($_data);
$_text[] = "
        <!-- END GLOBAL FONTS STYLES -->
        
        <!-- BEGIN PAGE GLOBAL STYLES -->
        ";function anon_FGDhwZVp($_data){};
$_text[] = anon_FGDhwZVp($_data);
$_text[] = "
        <!-- END PAGE GLOBAL STYLES -->
        
        <!-- BEGIN PAGE LEVEL STYLES -->
        ";function anon_BjjGsIvl($_data){};
$_text[] = anon_BjjGsIvl($_data);
$_text[] = "
...
$_text[] = " ) </div>
        ...
        <!-- BEGIN JAVASCRIPTS -->
            <!-- BEGIN CORE PLUGINS -->   
            ";function anon_HCKrKjjS($_data){};
$_text[] = anon_HCKrKjjS($_data);
$_text[] = "
            <!-- END CORE PLUGINS -->

            <!-- BEGIN CORE PLUGINS -->   
            ";function anon_bIoJRrNu($_data){};
$_text[] = anon_bIoJRrNu($_data);
$_text[] = "
            <!-- END CORE PLUGINS -->
        <!-- END JAVASCRIPTS -->
        <!-- BEGIN PREV MESSAGE -->
