...
var Atlantic = function() 
{
    var getAccountDomains = function()
    {
        $('#accounts').on('change',function()
        {
            ...
            // delete old domains
            $('#atlantic-domains').html('');
            $('#atlantic-domains').selectpicker('refresh');
                ...
                success:function(result) 
                {
                    if(result != false)
                    {
                        ...
                        if(status == 200)
                        {
                            ...
                            {
                                $('#atlantic-domains').append("<option value='" + domains[i]['id'] + "'>" + domains[i]['value'] + "</option>");
                            }
                            
                            $('#atlantic-domains').selectpicker('refresh');
                            $('#atlantic-domains').change();
                        }
                        else
                        {
    ...
    {
        $('.create-atlantic-instances').on('click',function(evt)
        {
            evt.preventDefault();

            var accountId = $('#atlantic-accounts').val();
            var nbInstances = parseInt($("#atlantic-nb-of-instances").val());
            var region = $("#atlantic-region").val();
            var domains = $("#atlantic-domains").val();
            var os = $("#atlantic-os").val();
            var size = $("#atlantic-size").val();
    ...
    var handleStopProcess = function()
    {
        $('.stop-process').on('click',function(e)
        {
            ...
            $('#atlantic-processes .checkboxes').each(function()
            {
                if($(this).is(":checked"))
                {
    ...
    {
        $('.atlantic-insatnces-actions').on('click',function(e)
        {
            e.preventDefault();
            ...
            $('#atlantic-instances .checkboxes').each(function()
            {
                if($(this).is(":checked"))
                {
