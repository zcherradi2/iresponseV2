...
var Linode = function() 
{
    var getAccountDomains = function()
    {
        $('#accounts').on('change',function()
        {
            ...
            // delete old domains
            $('#linode-domains').html('');
            $('#linode-domains').selectpicker('refresh');
                ...
                success:function(result) 
                {
                    if(result != false)
                    {
                        ...
                        if(status == 200)
                        {
                            ...
                            {
                                $('#linode-domains').append("<option value='" + domains[i]['id'] + "'>" + domains[i]['value'] + "</option>");
                            }
                            
                            $('#linode-domains').selectpicker('refresh');
                            $('#linode-domains').change();
                        }
                        else
                        {
    ...
    {
        $('.create-linode-instances').on('click',function(evt)
        {
            evt.preventDefault();

            var accountId = $('#linode-accounts').val();
            var nbInstances = parseInt($("#linode-nb-of-instances").val());
            var region = $("#linode-region").val();
            var domains = $("#linode-domains").val();
            var os = $("#linode-os").val();
            var size = $("#linode-size").val();
    ...
    var handleStopProcess = function()
    {
        $('.stop-process').on('click',function(e)
        {
            ...
            $('#linode-processes .checkboxes').each(function()
            {
                if($(this).is(":checked"))
                {
    ...
    {
        $('.linode-insatnces-actions').on('click',function(e)
        {
            e.preventDefault();
            ...
            $('#linode-instances .checkboxes').each(function()
            {
                if($(this).is(":checked"))
                {
